...
if ! grep --quiet "UUID=9A240B8B240B6A19 $WINDOWS_DIR ntfs-3g defaults,windows_names,locale=en_US.utf8 0 0" /etc/fstab; then
...
# add windows drive in fstab and mount it
if ! grep --quiet "UUID=9E04ADA204AD7E41 $DATA_DIR ntfs-3g defaults,windows_names,locale=en_US.utf8 0 0" /etc/fstab; then
